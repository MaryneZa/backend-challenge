...
func (ur *UserRepository) Create(ctx context.Context, user *domain.User) error {
	...
	if _, err := ur.collection.InsertOne(ctx, data); err != nil {
		return err
	}
	return nil
}
...
func (ur *UserRepository) Delete(ctx context.Context, id bson.ObjectID) error {
	filter := bson.D{{Key: "_id", Value: id}}
	if _, err := ur.collection.DeleteOne(ctx, filter); err != nil {
		return err
	}
	return nil
}
